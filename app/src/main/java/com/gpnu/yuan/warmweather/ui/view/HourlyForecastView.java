...
import com.gpnu.yuan.warmweather.utils.DisplayUtil;
import com.gpnu.yuan.warmweather.utils.IconUtils;
...
//        setLayerType(View.LAYER_TYPE_SOFTWARE, null);//关闭硬件加速
        ...
        paint1.setColor(mContext.getResources().getColor(R.color.yellow));
        ...
        //折线颜色
        foldLinePaint.setColor(mContext.getResources().getColor(R.color.yellow));
        ...
        textLinePaint.setColor(mContext.getResources().getColor(R.color.yellow));
        //底部时间文字颜色
        textPaint.setColor(mContext.getResources().getColor(R.color.arc_progress_color));

        baseLinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        baseLinePaint.setStrokeWidth(3);
        baseLinePaint.setStyle(Paint.Style.STROKE);
        baseLinePaint.setColor(mContext.getResources().getColor(R.color.shallow_yellow));
